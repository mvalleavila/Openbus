...
public class TcpProxyConfigParser {
    ...
    public static List<TcpProxyConfig> parse(Properties properties) {
        ...
        for (final String proxyName : proxyNames) {
            ...
            final boolean onlyActiveChecks = Boolean.valueOf(findProperty(properties, proxyName + ".onlyActiveChecks"));

            tcpProxyConfigs.add(new TcpProxyConfig(localPort, remoteHost, remotePort, onlyActiveChecks));
        }
